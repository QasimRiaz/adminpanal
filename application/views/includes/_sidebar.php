    ...
    <nav class="mt-2">
      ...
      <li id="users" class="nav-item ">
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a id="list-user" href="<?= base_url('user/'); ?>" class="nav-link">
            ...
            <li  class="nav-item">
              <a id="add-user" href="<?= base_url('user/add/'); ?>" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p>Add New User</p>
              </a>
            </li>
        ...
        <li id="workorders" class="nav-item ">
          ...
          <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a id="list-workorders" href="<?= base_url('complaints/'); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Work Order List</p>
                </a>
              </li>
              ...
              <li  class="nav-item">
                <a id="add-workorders" href="<?= base_url('complaints/add'); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
        ...
        <?php if($currentuserlevel == 'Client'){ ?>
              ...
              <li id="newwork" class="nav-item has-treeview">
                ...
                <a href="<?= base_url('complaints/add'); ?>" class="nav-link">
