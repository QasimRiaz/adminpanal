        ...
        <div class="card card-default color-palette-bo">
            ...
            <div class="card-body">   
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#main" role="tab" aria-controls="main" aria-selected="true">Admin Panal settings</a>
                  </li>
                  <!-- <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="pills-blogsettings" data-toggle="pill" href="#blogsettings" role="tab" aria-controls="blogsettings" aria-selected="false">Blog Setting</a>
                  </li>
                ...
                <div class="tab-content">
                    ...
                    <!-- Blog Setting -->
                    <div role="tabpanel" class="tab-pane" id="blogsettings">
                       
                       <div class="form-group">
                           <label class="control-label">Site Logo</label><br/>
                           <?php if(!empty($blog_settings['bloglogo'])): ?>
                               <p><img src="<?= base_url($blog_settings['bloglogo']); ?>" class="logo" width="150"></p>
                           <?php endif; ?>
                           <input type="file" name="sitelogo" accept=".png, .jpg, .jpeg, .gif, .svg">
                           <p><small class="text-success"><?= trans('allowed_types') ?>: gif, jpg, png, jpeg</small></p>
                           <input type="hidden" name="bloglogo" value="<?php echo html_escape($blog_settings['bloglogo']); ?>">
                       </div>
                       <div class="form-group">
                            <label class="control-label">Site Contact Email</label>
                            <input type="text" class="form-control" name="contact_email" placeholder="" value="<?php if(isset($blog_settings['contact_email'])){echo html_escape($blog_settings['contact_email']);} ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Site Contact Number</label>
                            <input type="text" class="form-control" name="contact_number" placeholder="" value="<?php if(isset($blog_settings['contact_number'])){echo html_escape($blog_settings['contact_number']);} ?>">
                        </div>
                        
                       <div class="form-group">
                            <label class="control-label">Facebook</label>
                            <input type="text" class="form-control" name="facebook_link" placeholder="" value="<?php if(isset($blog_settings['facebook_link'])){echo html_escape($blog_settings['facebook_link']);} ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Twitter</label>
                            <input type="text" class="form-control" name="twitter_link" placeholder="" value="<?php if(isset($blog_settings['twitter_link'])){echo html_escape($blog_settings['twitter_link']);} ?>">
                        </div>
                     
                        <div class="form-group">
                            <label class="control-label">Youtube</label>
                            <input type="text" class="form-control" name="youtube_link" placeholder="" value="<?php if(isset($blog_settings['youtube_link'])){echo html_escape($blog_settings['youtube_link']);} ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">LinkedIn</label>
                            <input type="text" class="form-control" name="linkedin_link" placeholder="" value="<?php if(isset($blog_settings['linkedin_link'])){echo html_escape($blog_settings['linkedin_link']);} ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Instagram</label>
                            <input type="text" class="form-control" name="instagram_link" placeholder="" value="<?php if(isset($blog_settings['instagram_link'])){echo html_escape($blog_settings['instagram_link']);} ?>">
                        </div>
