...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 20, 2023 at 01:33 PM
...
(12, 4, 0, 31, '2023-10-20 14:17:35'),
(13, 4, 0, 31, '2023-10-20 14:23:37'),
(14, 4, 0, 31, '2023-10-20 14:39:43'),
(15, 4, 0, 31, '2023-10-20 16:55:59'),
(16, 4, 0, 31, '2023-10-20 17:04:44'),
(17, 5, 0, 31, '2023-10-20 17:23:31'),
(18, 5, 0, 31, '2023-10-20 17:28:04');
...
CREATE TABLE IF NOT EXISTS `ci_activity_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ci_admin` (`admin_id`, `admin_role_id`, `username`, `firstname`, `lastname`, `company_name`, `designation`, `email`, `mobile_no`, `image`, `password`, `last_login`, `is_verify`, `is_admin`, `is_active`, `is_supper`, `token`, `password_reset_code`, `last_ip`, `created_at`, `updated_at`) VALUES
...
(32, 2, 'umer', 'umer', 'jamal', 'Bait al Sain', 'Manager', 'umer@gmail.com', '987456321', '', '$2y$10$iydXDZ6miB7BJ3Wdl.vkN.BuRJQu2U9P9bRKm8AXFN/obDoQYCFEq', '0000-00-00 00:00:00', 1, 1, 1, 0, '', '', '', '2023-10-15 00:00:00', '2023-10-20 05:10:04');
...
CREATE TABLE IF NOT EXISTS `ci_email_template_variables` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(95, 19, 'issuepicture', 'assets/img/cf183f0ef2c65d73a262bea5d085a82e.png'),
(94, 19, 'date', '2023-10-20T17:04'),
(93, 19, 'detail', 'Testing'),
(92, 19, 'loctiondetails', 'Test'),
(91, 19, 'workorderdetails', 'Test'),
(90, 19, 'created_at', '2023-10-20 : 05:10:44'),
(89, 19, 'tag', 'CIVIl'),
(88, 19, 'comtype', 'urgent'),
(87, 19, 'comstatus', 'open'),
(86, 19, 'subloction2', 'firstfloor'),
(85, 19, 'subloction', 'blockB'),
(84, 19, 'loction', 'Acc'),
(83, 19, 'mobileno', '789654'),
(82, 19, 'designation', 'Manager'),
(81, 19, 'reportedby', 'Abc');
...
(19, 31, '2023-10-20 05:10:44', '', 'WorkOrders', '', 'publish', '', '2023-10-20 05:10:44', 0, 'blogworkorder');
...
CREATE TABLE IF NOT EXISTS `ci_uploaded_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
